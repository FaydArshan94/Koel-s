...
return (
    <footer className=" font-sans px-6">
        <div className="h-[90vh] shadow-2xl overflow-hidden w-full relative text-zinc-100 pt-10 rounded-[3rem] items-center  mx-auto px-6 flex  justify-center bg-cover bg-[url('src/assets/black-abstract-marble-stone-texture-background_1017-40615.jpg')]">
            {/* Left iPhone */}
            <div className="flex  top-28 left-20 absolute justify-end h-full">
                <img
        ...
        {/* Bottom Footer */}
        <div className="flex justify-between items-center  py-10 px-6 w-full mx-auto">
            <div className="text-xs font-semibold  text-zinc-600 font-[MonaSans] ">
            ...
            <div className="flex gap-4">
                <a
                    ...
                    className="bg-transparent capitalize text-xs text-zinc-800 font-semibold font-[MonaSans] border-[1px] border-zinc-300  rounded-full w-28 h-12 flex items-center justify-center transition-colors duration-200 hover:bg-zinc-800 hover:text-zinc-100"
                >
                    facebook
                </a>
                <a
